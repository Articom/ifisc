         ...
         ?>
          <div data-role="fieldcontain">
             ...
             <div data-role="fieldcontain">
                ...
                <?php 
                echo '<input name="posicion" id="posicion" placeholder="Programador, administrador" value="'.$posicion.'" type="text">';
                 ?>
            </div>
             <div data-role="fieldcontain">
                <label for="salario">
                ...
                <?php 
                echo '<input name="salario" id="salario" placeholder="B/. 1, 000.00 mensual" value="'.$salario.'" type="text">';
                 ?>
            </div>
            <div data-role="fieldcontain">
                <label for="contacto">
            ...
            <div data-role="fieldcontain">
             ...
             <div data-role="fieldcontain">
                ...
                <textarea name="requisitos" id="requisitos" placeholder="Aspectos requeridos para aplicar a esta plaza..."><?php echo $requisitos; ?></textarea>
            </div>
             <div data-role="fieldcontain">
               <label for="contenido">
                    Descripción básica:
               </label>
               <textarea name="contenido" class="txteditable" id="contenido" class="txteditable" placeholder=""><?php echo $cuerpo; ?></textarea>
           </div>
           <div data-role="fieldcontain">
